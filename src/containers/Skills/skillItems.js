export const skillItems = [
    ...
    },
    {
        title: 'Framer Motion',
        items: [
            'Анимация компонентов React: Создание анимированных JSX-компонентов с помощью библиотеки',

            'Низкоуровневый API: Использование API для интеграции анимации и жестов в компоненты React, сохраняя при этом семантику HTML и SVG',

            'Работа с элементами: Использование специфических компонентов, таких как motion.div, который расширяет функциональность стандартных HTML-элементов',
        ],
        percent: '40',
    },
    {
        title: 'shadcn/ui',
        items: [
            'Базовая разработка UI: Понимание принципов проектирования пользовательских интерфейсов, чтобы правильно применять и кастомизировать компоненты.',
        ],
        percent: '30',
    },
    {
